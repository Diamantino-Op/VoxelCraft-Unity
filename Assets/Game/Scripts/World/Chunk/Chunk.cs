...
namespace VoxelCraft.World.Chunk
{
	public class Chunk : NetworkBehaviour
	{
		...
		void Start()
		{
			...
			GetComponent<Renderer>().material.SetTexture("_MainTex", world.gameManager.blockManager.atlas);
			GetComponent<Renderer>().material.SetTexture("_DetailAlbedoMap", world.gameManager.blockManager.atlas);
			GetComponent<Renderer>().material.SetFloat("_Mode", 1.0f);
			...
			for (int x = 0; x < _chunkSize; x++)
			{
				for (int y = 0; y < _chunkSize; y++)
				{
					for (int z = 0; z < _chunkSize; z++)
					{
						...
						{
							if (Block(pos + BlockPos.up) == world.gameManager.blockManager.getBlockByName("Air"))
							{
								CubeUp(x, y, z, block);
							}

							if (Block(pos + BlockPos.down) == world.gameManager.blockManager.getBlockByName("Air"))
							{
								CubeDown(x, y, z, block);
							}

							if (Block(pos + BlockPos.east) == world.gameManager.blockManager.getBlockByName("Air"))
							{
								CubeEast(x, y, z, block);
							}

							if (Block(pos + BlockPos.west) == world.gameManager.blockManager.getBlockByName("Air"))
							{
								CubeWest(x, y, z, block);
							}

							if (Block(pos + BlockPos.north) == world.gameManager.blockManager.getBlockByName("Air"))
							{
								CubeNorth(x, y, z, block);
							}

							if (Block(pos + BlockPos.south) == world.gameManager.blockManager.getBlockByName("Air"))
							{
				...
				for (int y = yS; y < yE; y++)
				{
					for (int z = zS; z < zE; z++)
					{
						...
						if (block != world.gameManager.blockManager.getBlockByName("Air"))
						{
							...
							if (dir == BlockManager.Dir.Up && Block(pos + BlockPos.up) == world.gameManager.blockManager.getBlockByName("Air"))
							{
								CubeUp(x, y, z, block);
							}

							if (dir == BlockManager.Dir.Down && Block(pos + BlockPos.down) == world.gameManager.blockManager.getBlockByName("Air"))
							{
								CubeDown(x, y, z, block);
							}

							if (dir == BlockManager.Dir.East && Block(pos + BlockPos.east) == world.gameManager.blockManager.getBlockByName("Air"))
							{
								CubeEast(x, y, z, block);
							}

							if (dir == BlockManager.Dir.West && Block(pos + BlockPos.west) == world.gameManager.blockManager.getBlockByName("Air"))
							{
								CubeWest(x, y, z, block);
							}

							if (dir == BlockManager.Dir.North && Block(pos + BlockPos.north) == world.gameManager.blockManager.getBlockByName("Air"))
							{
								CubeNorth(x, y, z, block);
							}

							if (dir == BlockManager.Dir.South && Block(pos + BlockPos.south) == world.gameManager.blockManager.getBlockByName("Air"))
							{
								CubeSouth(x, y, z, block);
							}
						}
		...
		private Block.Block Block(BlockPos pos)
		{
			...
			{
				return world.gameManager.blockManager.getBlockByName("Air");
			}
			else
			{
